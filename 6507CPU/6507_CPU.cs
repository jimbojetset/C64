...
namespace _6507CPU
{
    public class _6507_CPU
    {
        ...
        private int cyclesPerSecond = 1190000; // 1.1Mhz
        ...
        public void Run(ulong startVector = 0x0000)
        {
            ...
            while (running)
            {
                ...
                while(cyclesThisOperation < cyclesPerSecond)
                    Execute(GetNextInstruction());
                while(watch.ElapsedMilliseconds < 1000) { Thread.Sleep(1); }
                watch.Stop();
            }
        }
